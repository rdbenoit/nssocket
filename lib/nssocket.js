...
var NsSocket = exports.NsSocket = function (socket, options) {
  ...
  this._createdByServer = options.createdByServer;
...
NsSocket.prototype.sendRaw = function sendRaw(data, callback) {
    var dataType = typeof data,
          message;
...
NsSocket.prototype._setup = function () {
  ...
  //
  if (this._type === 'tcp4' || this._createdByServer) {
    startName = 'connect';
